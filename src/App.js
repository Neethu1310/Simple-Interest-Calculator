    ...
    <div className="App">
      <header className="App-header">
        <div className="container">
          ...
          <br />
          <Button onClick={handleReset} variant="outlined" id='reset'>Reset</Button>
          </div>
